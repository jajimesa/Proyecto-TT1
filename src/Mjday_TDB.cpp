...
//------------------------------------------------------------------------------
/**
 * @brief Función que calcula el número juliano modificado de una fecha en
 * tiempo bariocéntrico dinámico.
 * @param Mjd_TT "Modified Julian Date" en tiempo terrestre.
 * @return "Modified Julian Date" en tiempo bariocéntrico dinámico.
 */
//------------------------------------------------------------------------------
double Mjday_TDB(double Mjd_TT) {
